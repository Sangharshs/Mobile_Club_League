...
public class CricketAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    ArrayList<Match_Model> match_model_list;
    Match_Model match_model = new Match_Model();
    int p;

    public CricketAdapter(ArrayList<Match_Model> match_model_list,Context context, NativeAdsManager nativeAdsManager) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        ...
        switch (viewType)
        {
            ...
            case POST_TYPE:
           try {
                   ((ViewHolder) viewHolder).onBind(match_model_list.get(i));
    ...
    public int getItemCount() {
        //+ nativeAdList.size()
            return match_model_list.size()+ nativeAdList.size() ;
    }
    @Override
